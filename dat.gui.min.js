    ...
    var A = Array.prototype.forEach,
        ...
        N = {
            ...
            rgb_to_hsv: function (e, t, n) {
                ...
                return 0 === i
                    ? { h: NaN, s: 0, v: 0 }
                    : ((a = r / i), (s = e === i ? (t - n) / r : t === i ? 2 + (n - e) / r : 4 + (e - t) / r), (s /= 6) < 0 && (s += 1), { h: 360 * s, s: a, v: i / 255 });
            },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return X.isActive(this.__select)
                                ? this
                                : ((this.__select.value = this.getValue()), j(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'updateDisplay', this).call(this));
                        },
                    },
                ]),
                t
